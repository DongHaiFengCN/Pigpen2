...
public class SlideFinishActivityLayout extends LinearLayout {
    ...
    private void animToEnd() {
        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(this, "translationX", 0, getWidth() - endX);
    ...
    public void smoothScrollToStart() {
        if (mViewDragHelper.settleCapturedViewAt(0, getPaddingTop())) {
            ViewCompat.postInvalidateOnAnimation(this);
        }
    }
    ...
    public void smoothScrollToEnd() {
        ...
        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(this, "translationX", 0, getWidth());
        objectAnimator.addListener(new Animator.AnimatorListener() {
            @Override
            public void onAnimationStart(Animator animation) {
